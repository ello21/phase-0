...
// - I tried to do a long string of dot notation for
// terah.children.carson.name = "Carson"; This didn't
// work b/c carson first has to be defined as an Object
// before properties can be added to it. So it used object
// literal notation to create the object and assign the name
// property in one step.
//
// How difficult was it to add and delete properties outside
// of the object itself?
// - It wasn't difficult at all. It was good practice to see Object
// properties that point to other objects.
//
// What did you learn about manipulating objects in this challenge?
// - I hadn't used delete Obj.property before. When I looked it up
// I read that it can cause slow program execution and some programmers
// prefer to just give the property a value of undefined instead of deleting
// it. For this exercise, delete was best to ensure that the property was
